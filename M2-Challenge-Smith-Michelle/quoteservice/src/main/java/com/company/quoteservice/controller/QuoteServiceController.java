package com.company.quoteservice.controller;


import com.company.quoteservice.model.MagicBall;
import com.company.quoteservice.model.Quote;
import com.company.quoteservice.model.Word;
...
//    the controller is your route basically
...
//            https://www.oxfordlearnersdictionaries.com/
    ...
    public Quote getQuote() {
        ...
        Quote selectQuote = quoteList.get(quoteIndex);
//        System.out.println("random" + selectQuote);
        return selectQuote;
    }
...
//  integer: randomMagicIndex or the index/number = the random number from the magic 8 ball answer list or size
